...
public class ServicioDeUbicacionHeladera {
  ...
  private static final String urlApi = "URL";//TODO PONER URL DE UN MOCK
  ...
  public List<Coordenadas> listadoPosicionesHeladera(Coordenadas punto, float radio) throws IOException {
